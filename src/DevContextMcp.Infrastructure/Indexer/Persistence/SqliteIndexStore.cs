...
internal sealed partial class SqliteIndexStore : IIndexStore
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await UpsertSourceAsync(
            ...
            transaction: transaction,
            sourceId: sourceId,
            name: DocumentationLibraryId,
            environment: string.Empty,
            serviceIndex: source.RootPath,
            kind: "docs",
            cancellationToken: cancellationToken);
        ...
        await UpsertLibraryAsync(
            ...
            libraryId: libraryId,
            sourceId: sourceId,
            packageId: DocumentationLibraryId,
            kind: "docs",
            displayName: DocumentationDisplayName,
            cancellationToken: cancellationToken);
        ...
        else
        {
            ...
            await InsertPackageAsync(
                ...
                libraryId: libraryId,
                versionId: versionId,
                package: new PackageIndexData(
                    PackageId: DocumentationLibraryId,
                    Version: DocumentationVersion,
                    ContentHash: documentation.ContentHash,
                    Title: DocumentationDisplayName,
                    Description: "Internal company documentation and standards.",
                    Summary: null,
                    Authors: null,
                    Tags: "company documentation standards",
                    ProjectUrl: null,
                    RepositoryUrl: null,
                    IsListed: true,
                    IsPrerelease: false,
