...
## Demo 
Repository contains Demo Indexer data for [Demo Project](https://github.com/sbuyevich/demo-dev-context-mcp-server). `Demo Project` design and implementation were generated by AI agents using DevContext MCP server with indexing data below.

[Demo folder](./demo/) has 
- [Demo Applications](./demo/nuget-apps/) folder contains .Net applications to create demo NuGets.
  - [Demo.Cities](./demo/nuget-apps/Demo.Cities/) app to create demo nugets with `prod`and `qa` versions.
  - [OpenMeteo.Api.Client](./demo/nuget-apps/OpenMeteo.Client/) is OpenAPI generated cient.
- [Data](./demo/data/) folder with 
  - [NuGets Repo](/demo/data/nuget-repos/) folder contains *.nupkg files generated by demo app. Pathes of this repos are define in [Indexer Configuration](./docs/indexer-configuration.md)
  - [Idexer](./demo/data/indexer/) folders contains data for documents and NuGets indexing defined in [Indexer Configuration](./docs/indexer-configuration.md)
...
Run `Indexer` app once and look logs
